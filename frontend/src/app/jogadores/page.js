...
const POSITIONS = ['Todos', 'Goleiro', 'Zagueiro', 'Lateral Direito', 'Lateral Esquerdo', 'Volante', 'Meia', 'Atacante'];
...
export default function PlayersPage() {
  ...
  const filtered = posFilter === 'Todos' ? merged : merged.filter(p => p.position === posFilter || (p.position || '').includes(posFilter.split(' ')[0]));
